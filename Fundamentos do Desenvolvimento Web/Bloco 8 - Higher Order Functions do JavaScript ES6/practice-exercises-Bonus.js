...
const mageDamage = () => {
  const damageTotal = 
  {
    damage: chkMageDamage(),
    mana: battleMembers.mage.mana -= spentMana()
  }
  return damageTotal;
}

const chkMageDamage = () => {
  const damage = Math.random()*(mage.intelligence * 2 - mage.intelligence) + mage.intelligence;
  return damage;
}
